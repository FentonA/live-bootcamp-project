use auth_service::{
    ...
    hashset_banned_token_store::HashsetBannedTokenStore, utils::constants::test, Application,
};
...
impl TestApp {
    pub async fn new() -> Self {
        ...
        let app_state = AppState::new(Arc::new(RwLock::new(user_store)), token_store.clone());
